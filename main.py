...
async def main():
    ...
    carro3 = AgentCar("carro3@localhost", "123", position_x=0, position_y=4, direction="up", tag="003", shared_space=shared_space, intersections=intersections, waiting_time_manager=waiting_time)
